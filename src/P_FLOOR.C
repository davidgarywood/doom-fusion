...
void T_MoveFloor(floormove_t* floor)
{
  ...
  (
    ...
    floor->direction
                         ...
                         // [SM Code] Hakx 8/6/1999 -thanks to Fraggle
  ...
  if (res == pastdest)    // if destination height is reached
  {
    ...
    if (!silentmove(floor->sector)) // [SM Code] Hakx 8/6/1999 -thanks to Fraggle
...
void T_MoveElevator(elevator_t* elevator)
{
  ...
  if (!(leveltime&7) & (!silentmove(elevator->sector))) // [SM Code] Hakx 8/6/1999 -thanks to Fraggle
  ...
  if (res == pastdest)            // if destination height acheived
  {
    ...
    // make floor stop sound
    if (!silentmove(elevator->sector)) // [SM Code] Hakx 8/6/1999 -thanks to Fraggle
