...
// Fusion Cheats
static void cheat_infiniteammo(); // Hakx 7/31/1999
...
// Fusion Additional cheats
  {"massacre",     NULL,                not_net | not_demo,
   cheat_massacre },     // Hakx 7/26/1999 Heretic cheat names just 'cos :)

  {"kitty",     "No Clipping 3",        not_net | not_demo,
   cheat_noclip },

  {"alanmode",  "Infinite Ammo 1",      not_net | not_demo,
   cheat_infiniteammo },

  {"infinites", "Infinite Ammo 2",      not_net | not_demo,
   cheat_infiniteammo },
...
static void cheat_infiniteammo()
{
 if (!infinite_ammo)
   {
    infinite_ammo = 1;
    plyr->message = ("Infinite Ammo Mode On");
   } else
   {
    infinite_ammo = 0;
    plyr->message = ("Infinite Ammo Mode Off");
   }
}
