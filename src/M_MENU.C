...
extern int key_jump; // Hakx 8/23/1999 [Jump Code]
...
setup_menu_t keys_settings1[] =  // Key Binding screen strings       
{
  ...
  // Hakx 8/23/1999 [Jump Code]
  {"JUMP"        ,S_KEY       ,m_scrn,KB_X,KB_Y+12*8,{&key_jump},&mousebforward},
  {"MENUS"       ,S_SKIP|S_TITLE,m_null,KB_X,KB_Y+13*8},
  {"NEXT ITEM"   ,S_KEY       ,m_menu,KB_X,KB_Y+14*8,{&key_menu_down}},
  {"PREV ITEM"   ,S_KEY       ,m_menu,KB_X,KB_Y+15*8,{&key_menu_up}},
  {"LEFT"        ,S_KEY       ,m_menu,KB_X,KB_Y+16*8,{&key_menu_left}},
  {"RIGHT"       ,S_KEY       ,m_menu,KB_X,KB_Y+17*8,{&key_menu_right}},
  {"BACKSPACE"   ,S_KEY       ,m_menu,KB_X,KB_Y+18*8,{&key_menu_backspace}},
  {"SELECT ITEM" ,S_KEY       ,m_menu,KB_X,KB_Y+19*8,{&key_menu_enter}},
  {"EXIT"        ,S_KEY       ,m_menu,KB_X,KB_Y+20*8,{&key_menu_escape}},
...
// Hakx 8/10/1999
// Added gen_settings menu, shifted original general settings across one
...
{
  // Hakx 5/17/99 -Lets 1sided walls be rendered 2s if have no texture
  {"Render 1s, no texture linedefs as passable", S_YESNO, m_null, C_X,
   C_Y +compat_1sidepass * COMP_SPC, {"1sidepass"}},

  {"Render Invisible Things in MBF-style", S_YESNO, m_null, C_X,
   C_Y + compat_mbf_invis * COMP_SPC, {"m_mbf_invis"}},
...
setup_menu_t cred_settings[]={
  ...
  {"David Wood (Hakx)",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*prog + CR_SH*cr_prog},
...
*/
  ...
  {"Lee Killough",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*special + CR_SH*cr_special},
  ...
  {"Randy Heit",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*(adcr+2)+CR_SH*cr_adcr},
  {"Shawn Hargreaves \n& the Allegro Team",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*(adcr+3) + CR_SH*cr_adcr},
...
void M_DrawCredits(void)     // killough 10/98: credit screen
{
  ...
  V_DrawPatchTranslated(42,9,0, W_CacheLumpName("FUSTEXT",PU_CACHE),
			colrngs[CR_GOLD],0);
  V_MarkRect(0,0,SCREENWIDTH,SCREENHEIGHT);
