...
default_t defaults[] = {
  ...
  // Hakx 8/23/1999 [Jump Code]
  {
    "key_jump",
    &key_jump, NULL,
    KEYD_INSERT, {0,255}, number, ss_keys, wad_no,
    "key to jump"
  },
...
//
  ...
  { // Hakx 5/17/99 Fixing bugs on some wads with wierd windows
    "1sidepass",
    &single_side_pass, NULL,
    1, {0,1}, number, ss_none, wad_yes,
    "1 to render singlesided lines with no texture as passable"
  },
  { // Hakx 5/22/99 Switch between 'old style' invis and MBF style
    "m_mbf_invis",
    &mbf_invis, NULL,
    0, {0,1}, number, ss_none, wad_yes,
    "0 to render invis things in orig style, 1 to render in MBF style"
  },
  { // Hakx 8/9/1999 Obituaries on/off
    "m_obituaries",
    &obituaries, NULL,
    0, {0,1}, number, ss_none, wad_no,
    "0 for Obituaries off, 1 for Obituaries on"
  },
  { // Hakx 8/9/1999 Player's Name
    "player_name",
    (int *) &cl_name, NULL,
    (int) ("player"), {0}, string, ss_none, wad_no,
    "client's name"
  },
  { // Hakx 9/1/1999 Mlook Switching
    "m_mlookon",
    &mlookon, NULL,
    0, {0,1}, number, ss_none, wad_no,
    "0 for Mlook off, 1 for Mlook on"
  },
  { // Hakx 9/1/1999 Mouse Inversion Switching
    "m_invertmouse",
    &invertmouse, NULL,
    0, {0,1}, number, ss_none, wad_no,
    "0 for normal off, 1 for Inversion on"
  },
  { // Hakx 10/11/1999
    "cl_palettefx",
    &cl_palettefx, NULL,
    1, {0,1}, number, ss_none, wad_no,
    "Screen coloring effects ON/OFF"
  },
  { // Hakx 10/19/1999
    "jumpheight",
    &jumpheight, NULL,
    8, {0,16}, number, ss_none, wad_no,
    "Height a player can jump; equates to around this value * 7 pixels"
  },
  { // Hakx 10/19/1999
    "sv_gravity",
    &sv_gravity, NULL,
    10, {0,100}, number, ss_none, wad_no,
    "Gravity setting, a value of 1 is the normal doom gravity"
  },
  { // Hakx 2/13/00
    "cl_mlookspeed",
    &mlookspeed, NULL,
    3, {1,100}, number, ss_none, wad_no,
    "Mlook Speed"
  },
  { // Hakx 9/1/1999 Mlook Switching
    "cl_drawweapon",
    &cl_drawweapon, NULL,
    1, {0,1}, number, ss_none, wad_no,
    "1 for drawing the weapon, 1 for blank"
  },
