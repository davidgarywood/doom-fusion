...
// Fusion CHAR vars
char* s_OBT_FIST        = OBT_FIST;
char* s_OBT_PISTOL      = OBT_PISTOL;
char* s_OBT_SHOTGUN     = OBT_SHOTGUN;
char* s_OBT_CHAINGUN    = OBT_CHAINGUN;
char* s_OBT_RL          = OBT_RL;
char* s_OBT_PLASMA      = OBT_PLASMA;
char* s_OBT_BFG         = OBT_BFG;
char* s_OBT_CHAINSAW    = OBT_CHAINSAW;
char* s_OBT_SUPERSHOTGUN = OBT_SUPERSHOTGUN;
char* s_OBT_BETAPLASMA1 = OBT_BETAPLASMA1;
char* s_OBT_BETAPLASMA2 = OBT_BETAPLASMA2;

char* s_SELF_OBT_FIST        = SELF_OBT_FIST;
char* s_SELF_OBT_PISTOL      = SELF_OBT_PISTOL;
char* s_SELF_OBT_SHOTGUN     = SELF_OBT_SHOTGUN;
char* s_SELF_OBT_CHAINGUN    = SELF_OBT_CHAINGUN;
char* s_SELF_OBT_RL          = SELF_OBT_RL;
char* s_SELF_OBT_PLASMA      = SELF_OBT_PLASMA;
char* s_SELF_OBT_BFG         = SELF_OBT_BFG;
char* s_SELF_OBT_CHAINSAW    = SELF_OBT_CHAINSAW;
char* s_SELF_OBT_SUPERSHOTGUN = SELF_OBT_SUPERSHOTGUN;
char* s_SELF_OBT_BETAPLASMA1 = SELF_OBT_BETAPLASMA1;
char* s_SELF_OBT_BETAPLASMA2 = SELF_OBT_BETAPLASMA2;
...
// Fusion string vars
  {&s_OBT_FIST,      "OBT_FIST"},
  {&s_OBT_PISTOL,    "OBT_PISTOL"},
  {&s_OBT_SHOTGUN,   "OBT_SHOTGUN"},
  {&s_OBT_CHAINGUN,  "OBT_CHAINGUN"},
  {&s_OBT_RL,        "OBT_RL"},
  {&s_OBT_PLASMA,    "OBT_PLASMA"},
  {&s_OBT_BFG,       "OBT_BFG"},
  {&s_OBT_CHAINSAW,  "OBT_CHAINSAW"},
  {&s_OBT_BETAPLASMA1,"OBT_BETAPLASMA1"},
  {&s_OBT_BETAPLASMA2,"OBT_BETAPLASMA2"},

  {&s_SELF_OBT_FIST,      "SELF_OBT_FIST"},
  {&s_SELF_OBT_PISTOL,    "SELF_OBT_PISTOL"},
  {&s_SELF_OBT_SHOTGUN,   "SELF_OBT_SHOTGUN"},
  {&s_SELF_OBT_CHAINGUN,  "SELF_OBT_CHAINGUN"},
  {&s_SELF_OBT_RL,        "SELF_OBT_RL"},
  {&s_SELF_OBT_PLASMA,    "SELF_OBT_PLASMA"},
  {&s_SELF_OBT_BFG,       "SELF_OBT_BFG"},
  {&s_SELF_OBT_CHAINSAW,  "SELF_OBT_CHAINSAW"},
  {&s_SELF_OBT_BETAPLASMA1,"SELF_OBT_BETAPLASMA1"},
  {&s_SELF_OBT_BETAPLASMA2,"SELF_OBT_BETAPLASMA2"},
};
...
// Fusion
  ...
  // Len's Codepointers
  {A_DistanceDamage, "A_DistanceDamage"},
  {A_DistanceDamage, "A_DistanceDamage"},
  {A_SplitAttack,    "A_SplitAttack"},
  {A_ProjectileFire, "A_ProjectileFire"},
  {A_DetonateMisc,   "A_DetonateMisc"},
  {A_FireMancubus,    "A_FireMancubus"},
  {A_FireBaron,       "A_FireBaron"},
  {A_FireArachnotron, "A_FireArachnotron"},
  {A_FireCaco,        "A_FireCaco"},
  {A_FireImp,         "A_FireImp"},
  {A_ProjectileFire2, "A_ProjectileFire2"},
  {A_SkillJump,       "A_SkillJump"},
  // End Len's Codepointers

  {A_Massacre,       "A_Massacre"},
  {A_EnemyFireBFG,   "A_EnemyFireBFG"},
  {A_EnemyFirePlasma,"A_EnemyFirePlasma"},
  {A_EnemyFireBetaPlasma1,"A_EnemyFireBetaPlasma1"},
  {A_EnemyFireBetaPlasma2, "A_EnemyFireBetaPlasma2"},
  {A_EnemyFireRocket,"A_EnemyFireRocket"},
  {A_Burn,           "A_Burn"},
  {A_MFC_Shadow,     "A_MFC_Shadow"},
  {A_MFC_ShadowOn,   "A_MFC_ShadowOn"},
  {A_MFC_ShadowOff,   "A_MFC_ShadowOff"},
  {A_MFC_Float,       "A_MFC_Float"},
  {A_MFC_FloatOn,     "A_MFC_FloatOn"},
  {A_MFC_FloatOff,    "A_MFC_FloatOff"},
  {A_MFC_Touchy,      "A_MFC_Touchy"},
  {A_MFC_TouchyOn,    "A_MFC_TouchyOn"},
  {A_MFC_TouchyOff,   "A_MFC_TouchyOff"},
  {A_MFC_Friend,      "A_MFC_Friend"},
  {A_MFC_FriendOn,    "A_MFC_FriendOn"},
  {A_MFC_FriendOff,   "A_MFC_FriendOff"},
  {A_MFC_Translucent, "A_MFC_Translucent"},
  {A_MFC_TranslucentOn,"A_MFC_TranslucentOn"},
  {A_MFC_TranslucentOff,"A_MFC_TranslucentOff"},
  {A_MFC_Bounces,     "A_MFC_Bounces"},
  {A_MFC_Bounces,     "A_MFC_Bounces"},
  {A_MFC_BouncesOff,  "A_MFC_BouncesOff"},
  {A_MFC_Noblood,     "A_MFC_Noblood"},
  {A_MFC_NobloodOn,   "A_MFC_NobloodOn"},
  {A_MFC_NobloodOff,  "A_MFC_NobloodOff"},
  {A_FireBetaPlasma1, "A_FireBetaPlasma1"},
  {A_FireBetaPlasma2, "A_FireBetaPlasma2"},
  {A_FireRevenant,    "A_FireRevenant"},
  {A_MoveForward,     "A_MoveForward"},
  {A_MoveBackward,    "A_MoveBackward"},
  {A_MoveUp,          "A_MoveUp"},
  {A_MoveDown,        "A_MoveDown"},

  // Hakx 10/7/1999 [Shooters]
  {A_ShooterPistol,  "A_ShooterPistol"},
  {A_ShooterShotgun, "A_ShooterShotgun"},
  {A_ShooterDoubleShotgun, "A_ShooterDoubleShotgun"},
  {A_ShooterPlasma,  "A_ShooterPlasma"},
  {A_ShooterRocket,  "A_ShooterRocket"},
  {A_ShooterBFG,     "A_ShooterBFG"},
  {A_ShooterBetaPlasma1, "A_ShooterBetaPlasma1"},
  {A_ShooterBetaPlasma2, "A_ShooterBetaPlasma2"},
  ...
  while (fgets(inbuffer,sizeof(inbuffer),filein))
    {
      ...
      if (!*inbuffer || *inbuffer == '#' || *inbuffer == ' ' || *inbuffer == '/') // Hakx 8/21/1999 Added support for C-style comments
