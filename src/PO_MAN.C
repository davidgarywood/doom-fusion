...
boolean EV_RotatePoly (line_t *line, int polyNum, int speed, int byteAngle,

					int direction, boolean overRide)
{
	int mirror;
	polyevent_t *pe;
	polyobj_t *poly;
...
boolean EV_MovePoly (line_t *line, int polyNum, int speed, angle_t angle,

				  fixed_t dist, boolean overRide)
{
	int mirror;
	polyevent_t *pe;
	polyobj_t *poly;
...
boolean EV_OpenPolyDoor (line_t *line, int polyNum, int speed, angle_t angle,
